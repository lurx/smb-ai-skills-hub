...
Data to collect: Ads Manager export, Pixel/Events API status.
Platform references: `ads/references/tiktok-audit.md` (full 28-check audit), `ads/references/platform-specs.md` (creative specifications).
...
Render the TikTok Ads Health Score using the shared bar format in `ads/references/audit-process.md` with categories: Creative Quality (30%), Technical Setup (25%), Bidding & Budget (20%), Structure (15%), Performance (10%).

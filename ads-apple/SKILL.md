...
Data to collect: exports from the Apple Ads dashboard or pasted metrics.
Apple-specific step: identify active placement types (Search Results, Search Tab, Today Tab, Product Pages) before evaluating checks.

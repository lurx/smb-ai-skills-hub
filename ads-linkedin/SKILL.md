...
Data to collect: Campaign Manager export, Insight Tag status.
Platform references: `ads/references/linkedin-audit.md` (full 27-check audit).
...
Render the LinkedIn Ads Health Score using the shared bar format in `ads/references/audit-process.md` with categories: Technical Setup (25%), Audience (25%), Creative (20%), Lead Gen (15%), Budget & Bidding (15%).

...
Data to collect: account export, UET tag status, Google import validation results.
Platform references: `ads/references/microsoft-audit.md` (full 24-check audit).
...
Render the Microsoft Ads Health Score using the shared bar format in `ads/references/audit-process.md` with categories: Technical Setup (25%), Syndication (20%), Structure (20%), Creative (20%), Settings (15%).
